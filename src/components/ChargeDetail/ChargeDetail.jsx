...
ChargeDetail.defaultProps = {
  detail: [
    ['叠放柜', 'sark_one', '宽(100cm) * 高(40cm) * 深(56cm)', '• 叠放柜可存放针织类，卫衣棉服等可折叠衣物60件,也可提供真空袋出售；', '180￥/月', ''],
    ['挂放柜', 'sark_two', '宽(100cm) * 高(120cm) * 深(56cm)', '• 挂放柜可存放16件套装衣物，适合存放外套、大衣等大件衣物；', '300￥/月', ''],
    ['组合柜', 'sark_three', '宽(100cm) * 高(160cm) * 深(56cm)', '• 组合柜可存放60件折叠和16件挂放衣物，适合灵活存挂衣物；', '400￥/月', ''],
    ['礼服柜', 'sark_four', '宽(100cm) * 高(240cm) * 深(56cm)', '• 礼服柜可存放12件贵重礼服，适合存放大件礼服；', '60￥/件', '600￥/月', '']
  ]
}
