...
import {
  Form, Button, Checkbox, Row, Col, Input, InputNumber, Icon, Menu, Dropdown, Select, message
} from 'antd';
...
class ReceiptInfo extends Component {
  ...
  // 发票金额
  componentWillMount() {
    const user = JSON.parse(localStorage.getItem('closet_user'));
    const money = Number(user.recharge_amount) || 0;
    const active = money >= 3000;
    this.setState({
      amount: money,
      maxAmount: money
    });
        ...
        <div className={css.content}>
          ...
          */
          ...
          <div className={css.content_body_top}>
            <InputGroup>
              <Row className={css.cell}>
                <Col span={8} className={css.lf}>发票金额</Col>
                <Col span={13} className={css.rt}>
                  <Input
                    type="number"
            ...
            <InputGroup>
              <Row className={css.cell}>
                <Col span={8} className={css.lf}>发票类型 </Col>
                <Col span={16} className={css.rt}>
                  <Select
                    defaultValue="普通发票"
                    onChange={this.handleInvoiceType.bind(this)}
                    style={{ minWidth: 120 }}
                  >
          ...
          <div className={css.content_body_bottom}>
            <InputGroup>
              <Row className={css.cell}>
                <Col span={8} className={css.lf}>联系人</Col>
                <Col span={16} className={css.rt}>
            ...
            <InputGroup>
              <Row className={css.cell}>
                <Col span={8} className={css.lf}>联系电话</Col>
                <Col span={16} className={css.rt}>
            ...
            <InputGroup>
              <Row className={css.cell}>
                <Col span={8} className={css.lf}>邮政编码</Col>
                <Col span={16} className={css.rt}>
            ...
            <InputGroup>
              <Row className={css.cell}>
                <Col span={8} className={css.lf}>详细地址</Col>
                <Col span={16} className={css.rt}>
